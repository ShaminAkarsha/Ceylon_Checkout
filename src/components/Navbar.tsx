  ...
  return (
    <div>
      <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 w-11/12 max-w-6xl z-50">
        <div className="backdrop-blur-md bg-green-950 bg-opacity-50 border border-white border-opacity-20 rounded-2xl shadow-2xl">
          <div className="px-6 sm:px-8 py-4 flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-1">
              ...
              <div className="relative group">
                {/* Search Button */}
                <div
                  className="flex items-center space-x-1 px-4 py-2 rounded-lg font-medium text-white 
               hover:bg-white hover:bg-opacity-10 transition-all duration-200 cursor-pointer"
                >
               ...
               bg-green-950 bg-opacity-60 backdrop-blur-xl 
               ...
               group-hover:pointer-events-auto"
                >
                  <Link
                    ...
                    className="block px-4 py-3 text-sm font-bold text-white hover:bg-white hover:bg-opacity-10 transition"
                  >
                    Tours
                  </Link>
